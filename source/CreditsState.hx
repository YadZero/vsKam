...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var pisspoop:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			['Mod Credits.'],
			['Yad',                 'yad',              'I did everything lol\ncoding, music, art, and more stuf',  'https://twitter.com/YadMations',       '6bd66f'],
			['MSST',                'msst',             'Provided Kam singing audio',                               '',                                     'b54a4a'],
			[''],
			['Kam',                 'kam',              'He just singed\npoggers.',                                 '',                                     '3f8a41'],
			[''],
			['Psych Engine Team'],
