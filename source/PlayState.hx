...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		switch (curStage)
		{
			...
			case 'white': //Week 1
				var bg:BGSprite = new BGSprite('KamBG/Main', -1280, -720, 1, 0.95);
				add(bg);
		...
		if(curStage == 'white') {
			...
			if (curSong.toLowerCase() == "odiobeta") {
				remove(dadGroup);
				remove(boyfriendGroup);
				boyfriend = new Boyfriend(0, 0, SONG.player1, false);
				startCharacterPos(boyfriend);
				add(boyfriend);
				boyfriend.x += 350;
				boyfriend.y += 120;
				camFollow.set(boyfriend.getMidpoint().x - 100, boyfriend.getMidpoint().y - 100);
				camFollow.x -= boyfriend.cameraPosition[0] - -80;
				camFollow.y += boyfriend.cameraPosition[1] + 0;
				remove(iconP1);
				noLifeLoose = true;
				health = 2;
				// strum shit
				strumLineNotes.members[0 % PlayState.instance.strumLineNotes.length].x = -1000;
				strumLineNotes.members[1 % PlayState.instance.strumLineNotes.length].x = -1000;
				strumLineNotes.members[2 % PlayState.instance.strumLineNotes.length].x = -1000;
				strumLineNotes.members[3 % PlayState.instance.strumLineNotes.length].x = -1000;
			}
	    }
	}
